...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fake = new FakeDataManager(getApplicationContext());
    ...
    private class UserLoginTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            try {
                JSONObject user = fake.findUserByEmail(mEmail);
                ...
                if (email.equals(mEmail) && password.length() > 0) {
                    Boolean isPasswordCorrect = password.equals(mPassword);
                    if (isPasswordCorrect) {
                        // Account exists, save username and password
                        // then return 0 if the password matches.
